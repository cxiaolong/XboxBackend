...
CREATE TABLE IF NOT EXISTS users(
	...
	is_online TINYINT DEFAULT 0,                                  -- 用户在线状态：0不在线，1在线
 	group_username VARCHAR(10) NOT NULL,                          -- 用户的盒子分组表名（每个用户创建后建立一个默认的盒子分组表）
